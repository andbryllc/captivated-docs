...
1. The new message will route to the [queue](https://learn.captivated.works/help/admin-queues/), where designated queue operators can take the message and handle it themselves or transfer it to another queue or team member.
...
When you start a new conversation in Captivated, you are the owner of the conversation and the reply will go directly back to you and anyone you've added to the conversation. The only exception to this might be if you "[complete](https://learn.captivated.works/help/conversations-transferring/)" a conversation. See below for further explanation.
...
If you want to [leave a conversation](https://learn.captivated.works/help/conversations-transferring/) after completing it, you can select the "leave" option in the top right corner of the conversation.
