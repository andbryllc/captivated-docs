...
There are dozens of reasons that your message might show as failed. The easiest and fastest way to find the specific reason for the failure is to click on the drop down carrot to use our [failed message indicator](/features/sms-error-report) and it will show you the exact reason.
