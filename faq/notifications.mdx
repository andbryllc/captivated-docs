...
- If you are a [queue operator](https://learn.captivated.works/taking-a-message-from-the-queue/), you will also receive notifications anytime a new incoming message has been queued
