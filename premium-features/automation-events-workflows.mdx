...
- When a conversation is queued or [taken from a queue](https://learn.captivated.works/help/taking-a-message-from-the-queue/)
- When a [conversation is completed](https://learn.captivated.works/help/closing-leaving-and-joining/)
- When a message is [sent](https://learn.captivated.works/help/sending-a-message/) or received
- When a message is sent or received containing "X"
- When a [payment request](https://learn.captivated.works/express-pay/) or [form request](https://learn.captivated.works/help/requesting-a-form/) is completed
- When a custom button is clicked (created in workflows by Captivated Support)

#### Actions:

- Send a message or [template](https://learn.captivated.works/help/templates/)
- Invite a user to the conversation
- [Transfer a conversation](https://learn.captivated.works/help/conversations-transferring/) to a user or queue
- Add a [note](https://learn.captivated.works/help/adding-an-internal-note/) to the conversation
- [Complete the conversation](https://learn.captivated.works/help/conversations-transferring/)
- [Add or remove a tag](https://learn.captivated.works/help/tagging-contacts/) from a contact
