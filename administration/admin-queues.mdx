...
A Queue is simply a shared inbox where new incoming messages (text messages and live chats) route. You can have multiple [channels](https://learn.captivated.works/help/admin-channels/) routing to a single queue.
...
Additionally, you will see what [channels](https://learn.captivated.works/help/admin-channels/) route to the queue.
