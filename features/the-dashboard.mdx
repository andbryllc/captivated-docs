...
- Messages and [segments](https://learn.captivated.works/help/message-segments/) (160 character in one text message) per channel indicated by both inbound and outbound
- Outbound Messages
