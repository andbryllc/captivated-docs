...
4) Conversations with Scheduled messages = conversations that contain scheduled [messages](/features/scheduling-a-message) or [notes](https://learn.captivated.works/scheduling-notes/)
