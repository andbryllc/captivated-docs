...
- [contact exchange request](https://learn.captivated.works/help/contact-exchange-request/)
- [payment request](https://learn.captivated.works/express-pay/)
- [Google review request](https://learn.captivated.works/help/google-review-requests/)
- [booking request](https://learn.captivated.works/scheduling/)
- [location request](https://learn.captivated.works/help/requesting-a-location/)
- [form request](https://learn.captivated.works/help/requesting-a-form/)
...
Once you save the template, the template is automatically shared with you, the creator. If you'd like to share this with another [user](https://learn.captivated.works/help/admin-users/) or [team](https://learn.captivated.works/help/admin-teams/), hit the share icon and choose the user(s) or team(s) and decide if you'd like to give them the ability to edit the template with "write access".
