...
We recommend [adding the template](https://learn.captivated.works/creating-and-using-templates/) below to your account with a contact exchange request included, so that you can quickly send the request with a templated message.
